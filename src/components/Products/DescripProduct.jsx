...
export default () => {
  return (
    <section className=" px-4  mx-auto bg-slate-100 ">
...
rounded-md py-1 px-2"> 50%</span>
      ...
      <div className="">
        ...
        <div className=" flex bg-Orange-primary text-center p-5 rounded-lg text-white justify-center items-center gap-x-3 hover:bg-orange-600 transition-all" >
